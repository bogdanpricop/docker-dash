    ...
    el.innerHTML = `
      <div class="card" style="max-width:600px">
        ...
        <div class="card-body">
          ...
          <hr class="divider">
          <table class="info-table">
            <tr><td>${i18n.t('pages.settings.appVersion')}</td><td><a href="#/whatsnew" style="color:var(--accent);text-decoration:none">v3.9.1 <i class="fas fa-bullhorn" style="font-size:10px"></i></a></td></tr>
