  ...
  'governance-controls': {
    en: {
      ...
      sections: [
        ...
        { icon: 'fa-key', title: 'Workload exchange', body: 'Pinned public keys verify signed JWT proofs. Each signed proof and issuer/JWT-id pair can be redeemed once during its validity, including across trust recreation. Tokens never outlive the proof. Read-only mode refuses issuance; token, replay history and audit commit together. Upgrade 183 revokes prior workload tokens and their rotations. If unexpired old replay history exists, request a new proof after the upgrade cutoff (up to 61 seconds). Manual tokens are preserved. Trust changes do not revoke already issued tokens automatically.' },
