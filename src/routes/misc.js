...
router.get('/compare', (req, res) => {
  ...
  const features = [
    ...
    { feature: 'i18n', dockerDash: '11 languages', portainerCE: 'partial', dockge: false, dockhand: false },
    ...
    { feature: 'Test Suite', dockerDash: '384 tests', portainerCE: true, dockge: false, dockhand: false },
