...
exports.up = function up(db) {
  db.exec(`
    CREATE TABLE IF NOT EXISTS network_bond_health_observations (
    ...
    CREATE INDEX IF NOT EXISTS idx_network_bond_health_time
      ON network_bond_health_observations(observed_at DESC, id DESC);
  `);
};

exports.down = function down(db) {
  db.exec('DROP TABLE IF EXISTS network_bond_health_observations;');
};
