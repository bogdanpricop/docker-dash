...
const sources = ['src/routes/auth.js', 'src/services/auth.js', 'src/services/email.js',
  ...
  'src/routes/misc.js', 'src/middleware/monitoring-access.js', 'src/services/observability-import.js',
...
(async () => {
  ...
  try {
    ...
    for (const path of ['scripts/fixtures/password-reset-smoke.cjs', 'scripts/fixtures/oidc-flow-smoke.cjs', 'scripts/fixtures/api-key-smoke.cjs',
      ...
      'scripts/fixtures/service-token-tenant-smoke.cjs', 'scripts/fixtures/monitoring-access-smoke.cjs', ...tlsFixtures, ...(overlay ? sources : [])]) {
