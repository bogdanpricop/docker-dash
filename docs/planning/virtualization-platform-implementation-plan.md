...
| V4.2f | `62b80fc` | push + tag `v8.78.0`; PR #13; CI + 2 build-uri verzi | LAN `8.78.0-62b80fc` healthy; backup SQLite verificat | VPS `8.78.0-62b80fc` healthy; backup SQLite verificat | B082–B084, B087–B089, B091–B095, B097–B100: advanced storage plans, evidence adapters și Governance ledger fără implicit apply |
