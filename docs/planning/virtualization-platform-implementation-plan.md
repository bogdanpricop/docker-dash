...
| V4.3 | NIC/network/VLAN lifecycle | B101–B113 | intent + diff, fără lockout accidental; V4.3a–d oferă posture, policy, topologie și placement advisory numai read-only, fără persistență, trafic sau mutații |
