...
| V4.2 | Storage health/policy/QoS | B091–B100 | policy compliance, multipath și capacity; V4.2a a livrat baseline-ul read-only, iar V4.2b B091 vSphere consolidation strict-gated |
...
| V4.2b | pending | pending | pending | pending | B091 vSphere `ConsolidateVMDisks_Task`: evidence runtime, plan hash, typed confirm, durable task și post-read; restul B092–B100 rămân planificate |
