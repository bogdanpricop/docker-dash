...
| R5 | B129–B150 Backup/DR depth | P1 | XXL | `In progress` | V3.1–V3.6 | R5a are contractul comun B129–B138 local; adaptoarele XO/vSphere, canary și R5b/R5c rămân. |
| R6 | B151–B175 Security/compliance depth | P1 | XXL | `Partial` | provider SDK, governance | Evidence provider-native, remediation controlată și export de compliance. |
...
| 2026-07-31 | Release 8.80.0 | `In progress` | release candidate local | 308 suite / 3305 teste passed / 4 skipped; ESLint 0 errors; registry 391/59/0; gate-uri i18n/a11y și `git diff --check` | Lotul R5a conține exact 10 features, B129–B138. Include și restanțele locale R1–R4 validate cumulativ; browserul integrat nu a expus nicio instanță, iar canary provider rămâne separat și default-off. |
